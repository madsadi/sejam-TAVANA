...
export default function Home() {
  ...
  return (
    <IdpContext.Provider
      value={{ setLevel, level, setMobile, mobile, setToken, token }}
    >
      <div className="flex font-['PelakFA'] lg:flex-row flex-col-reverse xl:w-4/5 lg:w-[960px] sm:h-[90vh] responsive-padding h-[100dvh] sm:m-auto shadow-md sm:rounded-md overflow-hidden ">
