    ...
    <div>
      ...
      <div className={"h-[54px] relative bg-inputbg flex"}>
        ...
        <div
          role={"button"}
          className={
            "flex w-fit absolute left-0 before:block before:absolute before:w-0.5 before:right-0 before:bg-black/70 before:h-4/5 before:top-1/2 before:-translate-y-1/2 h-full px-4 hover:bg-border transition-all"
          }
          onClick={() => infoUpdate("uuid", uuidv4())}
        >
          <div className={"overflow-hidden w-fit p-1 pl-5"}>
            <img
              className={"h-full w-[100px] bg-contain"}
