  ...
  if (type === "password") {
            ...
            {countries.map((item: countryType) => {
              return (
                <li
                  ...
                  className={
                    "odd:bg-gray-200 cursor-pointer hover:bg-gray-100 px-2 py-1"
                  }
                >
                  {item.countryName}
                </li>
    ...
    return (
      <div className="dropdown w-full">
        ...
        <div
          tabIndex={1}
          className="input flex w-full items-center cursor-pointer"
        >
          ...
          {personType.map((item: any) => {
            return (
              <option
                key={item.id}
                value={item.id}
                onClick={() => infoUpdate("personType", item.id)}
                className={
                  "odd:bg-gray-200 cursor-pointer hover:bg-gray-100 px-2 py-1"
                }
              >
