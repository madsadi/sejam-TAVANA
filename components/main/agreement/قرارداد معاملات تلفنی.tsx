                            ...
                            <td className={'w-full content'}>
                                <div className={'leading-8 text-justify page'}>
                                    ...
                                    <div className={'mt-12 break-inside-avoid'}>
                                        ...
                                        <p>
                                            <span className="font-bold">تبصره: </span> اجراي موضوع در قالب دستور امضا شده و یا سایر
                                            اشکال؛ اعم
                                            از
                                    ...
                                    <p>
                                        <span className="font-bold">تبصره: </span> در مورد ماده فوق، با فرض قبول شرکت کارگزار، مشتري به
                                        شرکت
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            <span className="font-bold">تبصره 1: </span> مبالغ مندرج در این ماده و تبصره هاي آن، رأساً
                                            توسط
                                            شرکت
                                        ...
                                        <p>
                                            <span className="font-bold"> تبصره 2: </span> در صورت تنظیم قراردادهاي جداگانه؛ موضوع بند 3
                                            ماده 4
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            <span className="font-bold">تبصره: </span> در صورت تغییر اقامتگاه هر یک از طرفین قرارداد وعدم
                                            اطلاع
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            <span className="font-bold">تبصره: </span> در این صورت تاریخ فسخ، 3 روز کاري پس از ابلاغ کتبی
                                            تصمیم
