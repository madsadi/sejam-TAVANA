            ...
            <tr>
              <td className={"w-full content"}>
                <div className={"leading-8 text-justify page"}>
                  ...
                  <div>
                    <p>
                      قرارداد حاضر بین شرکت کارگزاري توانا (مشاوران سهام سابق) و
                      مشتري به شرح ذیل منعقد گردید. تعاریف دستورالعمل اجرایی
                      معاملات برخط اوراق بهادار در بورس اوراق بهادار تهران و فرا
                      بورس ایران در این قرارداد به همان مفاهیم به کار رفته است.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      محل ثبت: تهران، تاریخ ثبت: 1378/11/09، شماره تلفن:
                      42906-021، شماره نمابر: 89774797-021، آدرس سایت:
                      www.tavanaco.ir آدرس: تهران،خیابان میرعماد، نبش کوچه ی سوم
                      , روبروی فرمانداری پلاک 10 طبقه ی دوم شرقی ، کد پستی:
